...
vertexai.init(project=GCP_CONFIG["PROJECT_ID"], location=GCP_CONFIG["LOCATION"])
...
def embed_from_url():
    ...
    try:
        ...
        chunks, keywords, pages = chunk_text_by_structure(text_elements)
        ...
        print(f"------- Error in /ingest/pdf endpoint: {str(e)}")
